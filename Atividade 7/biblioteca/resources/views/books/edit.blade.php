...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('books.update', $book->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                <label for="cover_image" class="form-label">Imagem de Capa Atual</label><br>
                @if($book->cover_image)
                    <img src="{{ asset('storage/' . $book->cover_image) }}" alt="Capa do Livro" class="img-thumbnail mb-3" style="max-width: 200px;">
                @else
            ...
            <div class="mb-3">
                <label for="cover_image" class="form-label">Substituir Imagem de Capa</label>
                <input type="file" class="form-control" id="cover_image" name="cover_image">
                <small class="text-muted">Apenas arquivos do tipo: jpeg, png, jpg, gif. Tamanho máximo: 2MB.</small>
            </div>
